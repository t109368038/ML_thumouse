...
if not is_use_pre_train:
    ...
    model.add(TimeDistributed(Flatten(input_shape=( 1, 25, 25, 25)), input_shape=(timesteps, 1, 25, 25, 25)))
    ...
    adam = Adam(lr=1e-6, decay=1.5e-6)
    model.compile(optimizer=adam, loss='mean_squared_error')

es = EarlyStopping(monitor='val_loss', mode='min', verbose=1, patience=20)# 當val_loss最小50Epoch 都不變
mc = ModelCheckpoint(
