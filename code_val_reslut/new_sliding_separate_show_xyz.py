...
def show_error(camera_point,predict_p,x, y, z, stdx, stdy, stdz, title):
    ...
    plt.savefig("D:\\thumouse_training_data_new\\transfer_0dot5\\fig\\"+ title +".png")
    # plt.close()
...
for i in Gesture:
    for j in range(2, 4):
        ...
        path = 'D:/thumouse_training_data_new/'+ name +'/sliding_data/'
        head_path = "D:/thumouse_training_data_new/model/"
        ...
        if timesteps == 3:
            out_radar_p = out_radar_p[:78]
            out_cam_p = out_cam_p[:78,-1, :]
