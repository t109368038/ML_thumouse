...
for i in Gesture:
    for j in range(2, 3):
        ...
        # model = keras.models.load_model("D:\\pythonProject\\ML_thumouse\\New_model\\lstm_sliding_larrysrc_timestep12_adam.h5")
        # model = keras.models.load_model(head_path+"moving_average_lastout.h5")
        # model = keras.models.load_model(head_path+"moving_average_out_mid_range_test.h5")
        model = keras.models.load_model(head_path+name+".h5")
